        ...
        void loadScene(string filename)
        {
            ...
            foreach (JObject image in images)
            {
                ...
                else
                {
                    ...
                    bulletcolisions.Add(new Sprite(Content, imageName, new Vector2(x, y)));
                }
                //layers para listas diferentes aqui
            }
            
            bulletcolisions.Add(new Sprite(Content, "Red0L",bryanpos));
            bulletcolisions.Add(new Sprite(Content, "Blue0R", jackpos));
        }
